...
function Navbar() {
  ...
  return (
    <>
      <div className={`mx-auto max-w-screen-2xl z-50 container md:px-20 px-4 fixed top-0 right-0 left-0 ${
        ...
        <div className="navbar">
          ...
          <div className="navbar-end space-x-2">
            ...
            <div>
              <a className="bg-black text-white px-3 py-2 rounded-md cursor-pointer hover:bg-slate-700">
                Login
              </a>
            </div>
          </div>
